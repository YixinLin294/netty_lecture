...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return StudentProto.internal_static_com_example_proto_StreamRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return StudentProto.internal_static_com_example_proto_StreamRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            StreamRequest.class, Builder.class);
  }

  public static final int REQUEST_INOF_FIELD_NUMBER = 1;
  private volatile Object requestInof_;
  /**
   * <code>string request_inof = 1;</code>
   * @return The requestInof.
   */
  @Override
  public String getRequestInof() {
    Object ref = requestInof_;
